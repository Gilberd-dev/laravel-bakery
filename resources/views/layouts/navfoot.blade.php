    ...
    <div class="container">
        <div class="row">
            ...
            <div class="footer-col col-lg-3">
                <h4>Find Us</h4>
                <ul>
                    <li><a href="https://web.facebook.com/pages/Pizza-Etnik-Toba/156817371650659"> <img src="../pict/facebook.png" style="width: 20px;"> Pizza Etnik Toba</a></li>
                    <li><a href="https://www.instagram.com/pizzaetniktoba5/?igshid=YmMyMTA2M2Y%3D"> <img src="../pict/instagram.png" style="width: 20px;"> Pizza Etnik Toba</a>
                    </li>
                    <li><a href="https://wa.me/6281375089145"> <img src="../pict/whatsapp.png" style="width:20px;"> +62 813-7508-9145</a></li>
                </ul>
            </div>
            <div class="footer-col col-lg-3">
                <h4>Location</h4>   
