              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">{{ $row -> nama_admin }}</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">No. Telp</div>
                    <div class="col-lg-9 col-md-8">{{ $row -> nomor_telepon_admin }}</div>
                  </div>
                </div>
                  ...
                  <form  role="form" action="/edit_profile/{{ $row->id }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <img src="Pict/{{ $row -> foto_admin }}" alt="Profile">
                        <div class="pt-2">
                          <!-- <a href="#" class="btn btn-primary btn-sm" title="Upload new profile image"><i class="bi bi-upload"></i></a>
                          <a href="#" class="btn btn-danger btn-sm" title="Remove my profile image"><i class="bi bi-trash"></i></a> -->
                          <!-- <div class="col-sm-10"> -->
                          <input class="form-control" type="file" id="formFile" name="foto_admin">
                          <!-- </div> -->
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="nama_admin" type="text" class="form-control" id="fullName" value="{{ $row -> nama_admin }}">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="nomor_telepon_admin" type="text" class="form-control" id="Phone" value="{{ $row -> nomor_telepon_admin }}">
                      </div>
                    </div>
