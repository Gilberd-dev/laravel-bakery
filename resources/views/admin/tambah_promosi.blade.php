            ...
            <section class="section">
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Tambah Data Promosi</h5>

                                <!-- General Form Elements -->
                                <form role="form" action="/tambah_promosi" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row mb-3">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea class="form-control" style="height: 100px" name="deskripsi_carousel"></textarea>
                                        </div>
                                    </div>
